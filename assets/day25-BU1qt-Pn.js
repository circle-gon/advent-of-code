import{c as m}from"./emwasm-Dw92gTPk.js";import{m as r}from"./index-gvt7MWwt.js";import{i as s}from"./intcode-YJkym2R9.js";const c=`
${s}
...
`,p=m(c,{},{});async function l(t,a){let i,o;const e=document.createElement("input"),u=document.createElement("pre"),d=document.createElement("button");for(d.textContent="Submit",e.addEventListener("keydown",n=>{n.key==="Enter"&&o(e.value)}),d.addEventListener("click",()=>o(e.value)),a([document.createElement("br"),"Command: ",e,d,document.createElement("br"),u]);;){const n=t.run();if(u.textContent=new TextDecoder().decode(new Uint8Array(t.output.buffer).subarray(0,t.outIdx.value)),e.value="",{promise:i,resolve:o}=Promise.withResolvers(),r(await i+`
`,t.commands),n)return}}async function f(t,a,i,o){const{module:e,memory:u}=await p;return r(t,u),e.part1(),o?l(e,a):e.part1boring()}const v=[f];export{v as default};
