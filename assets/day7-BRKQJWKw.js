import{c as d}from"./emwasm-CgbW5bdp.js";import{m as r}from"./index-Cn1uEpnO.js";const n=`
...
`,u=d(n,{},{});async function y(e){const{module:t,memory:i}=await u;return r(e,i),t.part1()}async function a(e){const{module:t,memory:i}=await u;return r(e,i),t.part2()}const f=[y,a];export{f as default};
