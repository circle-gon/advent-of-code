import{c as n}from"./emwasm-CgbW5bdp.js";import{m as r}from"./index-Cn1uEpnO.js";const a=`
...
`,t=n(a,{},{});async function s(u){const{module:e,memory:i}=await t;return r(u,i),e.part1()}async function d(u){const{module:e,memory:i}=await t;return r(u,i),e.part2()}const p=[s,d];export{p as default};
