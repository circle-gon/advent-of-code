import{c as a}from"./emwasm-jdxru8Ro.js";import{m as u}from"./index-DTf0R7fQ.js";import{i as r}from"./intcode-DD3AWPIW.js";const i=`
${r}
let ip = u32(0)
let rel = s32(0)
let output = u32(0)
...
`,n=a(i,{},{});async function d(e){const{module:s,memory:t}=await n;return u(e,t),s.part1()}async function y(e){const{module:s,memory:t}=await n;return u(e,t),s.part2()}const m=[d,y];export{m as default};
