import{c as r}from"./emwasm--tg4IAJG.js";import{m as t}from"./index-vH6bm6Wv.js";const n=`
...
`,s=r(n,{},{});async function a(e){const{module:u,memory:i}=await s;return t(e,i),u.part1()}async function d(e){const{module:u,memory:i}=await s;return t(e,i),u.part2()}const p=[a,d];export{p as default};
