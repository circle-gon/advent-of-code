import{a,m as i}from"./index-CbGXu4SM.js";const c=`
...
`,e=a(c);async function $(l){const{module:o,memory:t}=await e;return i(l,t),o.part1()}async function s(l){const{module:o,memory:t}=await e;return i(l,t),o.part2()}const n=[$,s];export{n as default};
