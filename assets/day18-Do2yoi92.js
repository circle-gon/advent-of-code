import{c as r}from"./emwasm-CoPIFzXk.js";import{m as t}from"./index-Ds_q8QYG.js";const n=`
...
`,s=r(n,{},{});async function a(e){const{module:u,memory:i}=await s;return t(e,i),u.part1()}async function d(e){const{module:u,memory:i}=await s;return t(e,i),u.part2()}const y=[a,d];export{y as default};
