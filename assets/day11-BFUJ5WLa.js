import{c as m}from"./emwasm-Ctrcd4uU.js";import{m as i}from"./index-GwZZPAxQ.js";const n=`
...
`,e=m(n,{},{});async function p(t){const{module:u,memory:a}=await e;return i(t,a),u.part1()}async function r(t){const{module:u,memory:a}=await e;return i(t,a),u.part2()}const f=[p,r];export{f as default};
