import{c as a}from"./emwasm-b25LuFOt.js";import{m as r}from"./index-DQLiBMR0.js";import{i as o}from"./intcode-BuwA_ZA0.js";const l=`
${o}
...
`,d=a(l,{},{});async function c(e){const{module:i,memory:t}=await d;return r(e,t),i.part1()}async function f(e,i){const t=document.createElement("pre");for(i([t]);;){const n=e.run();if(n!==1347376211)return n;t.textContent=new TextDecoder().decode(new Uint8Array(e.chars.buffer).subarray(0,e.maxindex.value)),t.scrollIntoView({behavior:"smooth",block:"center"}),await new Promise(u=>setTimeout(u,60))}}async function s(e,i,t,n){const{module:u,memory:x}=await d;return r(e,x),u.part2(n),n?f(u,i):u.run()}const y=[c,s];export{y as default};
