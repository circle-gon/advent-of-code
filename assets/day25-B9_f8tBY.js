import{c as r}from"./emwasm--tg4IAJG.js";import{m}from"./index-vH6bm6Wv.js";import{i as s}from"./intcode-DD3AWPIW.js";const c=`
${s}
...
`,p=r(c,{},{});async function l(t,i){let a,o;const e=document.createElement("input"),u=document.createElement("pre"),d=document.createElement("button");for(d.textContent="Submit",e.addEventListener("keydown",n=>{n.key==="Enter"&&o(e.value)}),d.addEventListener("click",()=>o(e.value)),i([document.createElement("br"),"Command: ",e,d,document.createElement("br"),u]);;){const n=t.run();if(u.textContent=new TextDecoder().decode(new Uint8Array(t.output.buffer).subarray(0,t.outIdx.value)),e.value="",{promise:a,resolve:o}=Promise.withResolvers(),m(await a+`
`,t.commands),n)return}}async function f(t,i,a,o){const{module:e,memory:u}=await p;return m(t,u),e.part1(),o?l(e,i):e.part1boring()}const y=[f];export{y as default};
