import{c as r}from"./emwasm-Dw92gTPk.js";import{m as d}from"./index-gvt7MWwt.js";const o=`
...
`,s=r(o,{},{});async function u(e){const{module:t,memory:i}=await s;return d(e,i),t.part1()}async function a(e){const{module:t,memory:i}=await s;return d(e,i),t.part2()}const x=[u,a];export{x as default};
