import{c as a}from"./emwasm-Dw92gTPk.js";import{m as c}from"./index-gvt7MWwt.js";const f=`
...
`,o=a(f,{},{});async function i(n){const{module:e,memory:r}=await o;return c(n,r),e.part1(),new TextDecoder().decode(new Uint8Array(e.clean.buffer).subarray(0,8))}async function d(n){const{module:e,memory:r}=await o;c(n,r),e.part2();const t=new DataView(e.clean.buffer).getUint32(0,!0);return new TextDecoder().decode(new Uint8Array(e.clean.buffer).subarray(t,t+8))}const l=[i,d];export{l as default};
