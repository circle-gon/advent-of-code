import{c as m}from"./emwasm-jdxru8Ro.js";import{m as i}from"./index-DTf0R7fQ.js";import{i as s}from"./intcode-DD3AWPIW.js";const x=`
${s}
drawn = memory<u8>(1)
...
`,a=m(x,{},{});async function o(t){const{module:e,memory:r}=await a;return i(t,r),e.part1()}async function y(t){const{module:e,memory:r}=await a;i(t,r),e.part2();const n=document.createElement("pre");return n.textContent=new TextDecoder().decode(new Uint8Array(e.output.buffer).subarray(0,e.len.value)),[n]}const l=[o,y];export{l as default};
