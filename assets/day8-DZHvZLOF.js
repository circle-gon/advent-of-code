import{c as n}from"./emwasm-CgbW5bdp.js";import{m as i}from"./index-Cn1uEpnO.js";const m=`
...
`,r=n(m,{},{});async function a(e){const{module:u,memory:o}=await r;return i(e,o),u.part1()}async function l(e){const{module:u,memory:o}=await r;i(e,o),u.part2();const t=document.createElement("pre");return t.textContent=new TextDecoder().decode(new Uint8Array(u.out.buffer).subarray(0,156)),[t]}const x=[a,l];export{x as default};
