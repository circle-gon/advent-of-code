import{c as s}from"./emwasm-CoPIFzXk.js";import{m as r}from"./index-Ds_q8QYG.js";import{i as d}from"./intcode-BuwA_ZA0.js";const n=`
${d}
temp = memory<s64>(15)
...
fn run(cid: u32)(base: u32, fake: u32, fake2: s32) -> u32 {
  ...
  fake, fake2 = evalIntcode(u32(temp[base]), i32(temp[base + 1]), get, set)
  memory.copy(temp, program, (base + 2) * i64.size, 0, range)
  temp[base] = s64(fake)
  temp[base + 1] = i64(fake2)
  return output
}
...
fn run2(cid: u32)(base: u32, fake: u32, fake2: s32) {
  ...
  // Skip ip and rel
  memory.copy(program, temp, 0, (base + 2) * i64.size, range)
  fake, fake2 = evalIntcode(u32(temp[base]), i32(temp[base + 1]), get, set2)
  memory.copy(temp, program, (base + 2) * i64.size, 0, range)
  temp[base] = s64(fake)
  temp[base + 1] = i64(fake2)
}
...
`,i=s(n,{},{});async function u(e){const{module:a,memory:t}=await i;return r(e,t),a.part1()}async function p(e){const{module:a,memory:t}=await i;return r(e,t),a.part2()}const c=[u,p];export{c as default};
