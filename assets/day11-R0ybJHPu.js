import{c as s}from"./emwasm-Dw92gTPk.js";import{m as i}from"./index-gvt7MWwt.js";import{i as x}from"./intcode-YJkym2R9.js";const m=`
${x}
drawn = memory<u8>(1)
...
`,a=s(m,{},{});async function o(t){const{module:e,memory:r}=await a;return i(t,r),e.part1()}async function y(t){const{module:e,memory:r}=await a;i(t,r),e.part2();const n=document.createElement("pre");return n.textContent=new TextDecoder().decode(new Uint8Array(e.output.buffer).subarray(0,e.len.value)),[n]}const l=[o,y];export{l as default};
