import{c as m}from"./emwasm-Dw92gTPk.js";import{m as t}from"./index-gvt7MWwt.js";const n=`
...
`,u=m(n,{},{});async function d(o){const{module:i,memory:e}=await u;return t(o,e),i.part1()}async function a(o){const{module:i,memory:e}=await u;return t(o,e),i.part2()}const x=[d,a];export{x as default};
